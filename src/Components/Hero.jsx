...
import { Zap, Download, Mail, Cpu, Brain, Layers, Code2, ArrowRight } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-xl">
              I engineer scalable backend systems, custom deep-learning models, and 
              high-performance C++/CUDA tools. Passionate about ML infrastructure,
              systems programming, and impactful full-stack products.
            </p>
            ...
            <div className="flex gap-4 flex-wrap pt-2">
              <a
                href="/resume.pdf"
                className="group relative inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold shadow hover:scale-105 transition"
              >
              ...
              <button
                className="px-6 py-3 rounded-full border font-bold hover:bg-gray-900 hover:text-white transition"
              >
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 max-w-md">
              {[
                { icon: <Cpu className="w-5 h-5" />, label: "Systems Engineering" },
                { icon: <Brain className="w-5 h-5" />, label: "Deep Learning (LSTM, CNN, Transformers)" },
                { icon: <Layers className="w-5 h-5" />, label: "Full Stack MERN" },
                { icon: <Code2 className="w-5 h-5" />, label: "C++ / CUDA / Rust" },
              ].map((s, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <p className="text-sm font-semibold text-gray-700 leading-tight">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
